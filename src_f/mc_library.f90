module mc_library
    ...
    subroutine move_particle(delta_x, dist_in_cell, mu, sigma_scat, sigma_tot, distance_to_collision, &
    ...
    subroutine check_distance_lp_x(thickness, sigma_scat, sigma_tot, mu, distance, distance_to_interface, &
    ...
    end subroutine check_distance_lp_x
